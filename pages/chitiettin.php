...
$row_tin = mysqli_fetch_array($tin, MYSQLI_BOTH);
?>

<h1 class="title"><?php echo $row_tin["TieuDe"]?></h1>
<!--<div class="des"><?php /*?><?php echo $row_tin["TomTat"]?><?php */?>
</div>-->
<div class="chitiet">
<!--noi dung-->
...
<div class="clear"></div>
	<ul>
    	<?php
			$idLT = $row_tin["idLT"];
			$tincungloai = TinCungLoai($idTin, $idLT);
			while($row_tincungloai = mysqli_fetch_array($tincungloai, MYSQLI_BOTH)){
