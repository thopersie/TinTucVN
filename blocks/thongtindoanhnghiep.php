...
<div class="thongtin-content">
    ...
    <div id="slider1_container" style="position: relative; top: 0px; left: 0px; width: 1000px; height: 150px; overflow: hidden;">
        ...
        <!-- Slides Container -->
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1000px; height: 115px; overflow: hidden;">
            <?php 
			$qcao = QuangCao(2);
			while ($row_qcao = mysqli_fetch_array($qcao, MYSQLI_BOTH)){
			?>
            <div><img u="image" src="upload/quangcao/<?php echo $row_qcao["urlHinh"]?>" /></div>
            <?php 
			}
			?>
        </div>
